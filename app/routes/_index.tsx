  ...
  return (
    <div className="relative">
      ...
      <div className="relative py-24 sm:py-32">
        ...
        >
          <div
            className="from-[#ff80b5] to-[#FFB612] opacity-30 sm:left-[calc(50%-30rem)] sm:aspect-[1155/678] sm:w-[72.1875rem] sm:w-[72.1875rem] sm:bg-gradient-to-tr"
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8" id="learn-more">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              We want you to always have a new puzzle to complete, and a new
              board game to conquer. But how???
            </p>
          </div>
          ...
          <div className="mx-auto max-w-2xl lg:text-center">
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Then Pass out at three wake up at ten Go out to eat then do it
              again
            </p>
          </div>
        </div>
              ...
              <div className="rounded-2xl py-10 text-center ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                <div className="mx-auto max-w-xs px-8">
                  <p className="text-base font-semibold text-gray-600">
                    Don't worry we'll do the math for you... one 1000 piece
                    puzzle averages $28
                  </p>
